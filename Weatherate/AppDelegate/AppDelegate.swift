...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //AIzaSyBCHJndLlAYhwWjLEdgExXzx6BWcI29ZWY
        //AIzaSyA62oPZTaIxqpELx3LLxQfvbCJwf6WkX08 my
        GMSPlacesClient.provideAPIKey("AIzaSyBCHJndLlAYhwWjLEdgExXzx6BWcI29ZWY")
        
        // Customize the UI of GMSAutocompleteViewController
        let barColor: UIColor =  _ColorLiteralType(red: 0.42745098, green: 0.61960784, blue: 0.83137255, alpha: 1)
